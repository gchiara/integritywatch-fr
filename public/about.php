        ...
        <div class="panel-group" id="accordion">
          ...
          <div class="panel panel-default">
            ...
            <div id="collapse4" class="panel-collapse collapse in">
              <div class="panel-body">
                <p>Integrity Watch est un outil développé par Transparency International qui a vocation à présenter aux citoyens les déclarations d’intérêts des parlementaires, dans un objectif de prévention des conflits d’intérêts. Integrity Watch reprend le contenu des déclarations d'intérêts telles que disponibles en ligne au 01/06/2020, telles qu’elles ont été transmises à la HATVP. Nous ne procédons à aucun retraitement manuel. Il appartient à chaque parlementaire de veiller à ce que les déclarations soient conformes aux exigences légales et correctement actualisées. Transparency International France ne saurait être tenue responsable d’éventuelles erreurs sur les données publiées, et vous invite le cas échéant à effectuer une déclaration modificative auprès de la Haute Autorité pour la Transparence de la Vie Publique afin que ces nouvelles données soient intégrées dans la prochaine actualisation d’Integrity Watch. Les erreurs les plus fréquemment rencontrées concernent les activités conservées des parlementaires, l’identité et les activités annexes des collaborateurs parlementaires, et les activités des conjoints. Les parlementaires peuvent se référer au guide du déclarant disponible sur le site de la <a href="https://www.hatvp.fr/wordpress/wp-content/uploads/2018/04/guide-du-declarant-avril-2018.pdf" target="_blank">HATVP</a>.</p>
              </div>
            </div>
          </div>
          <!-- SECTION TITLE -->
